...
mixin _$OrdersResult<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(T order) success,
    required TResult Function(String message) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T order)? success,
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OrdersResult<$T>.success(order: $order)';
  }
...
abstract class Success<T> implements OrdersResult<T> {
  factory Success(final T order) = _$Success<T>;
